...
async function initAdapterManager() {
  ...
  const manager = {
    ...
    config: async () => {
      var _configFromAdapter$ex, _configFromAdapter5, _configFromAdapter6, _configFromAdapter7, _configFromAdapter$pl, _configFromAdapter8;
...
const customHeaderFilter = (route, pathPrefix) => h => {
  for (const baseHeader of _constants.BASE_HEADERS) {
